import { Loader2Icon, LogInIcon, LogOutIcon, CheckCircle2Icon } from 'lucide-react'
  ...
  if (todayRecord?.checkOut) {
    return (
      ...
      >
        ...
        >
          <CheckCircle2Icon size={22} strokeWidth={1.5} style={{ color: '#34d399' }} />
        </div>
        <div>
  ...
  return (
    ...
    >
      ...
      <div className='flex-1 min-w-0'>
        ...
        <p className='text-[11.5px] mt-0.5' style={{ color: 'var(--text-subtle)' }}>
          {loading
            ? 'Please wait'
            : isCheckedIn
      ...
      {!loading && (
        <span className='relative flex h-2.5 w-2.5 shrink-0'>
          ...
          <span
            ...
            style={{ background: isCheckedIn ? '#34d399' : 'rgba(255,255,255,0.15)' }}
          />
        </span>
      )}
    </button>
