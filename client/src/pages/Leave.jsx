...
import { PalmtreeIcon, PlusIcon, ThermometerIcon, UmbrellaIcon, FileTextIcon } from 'lucide-react'
...
const Leave = () => {
  ...
  let sickCount = 0, casualCount = 0, annualCount = 0
  leaves.forEach(l => {
      ...
      <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8'>
        <div>
          <div className='flex items-center gap-2 mb-2'>
            <FileTextIcon size={13} strokeWidth={1.5} style={{ color: 'var(--accent)' }} />
            <span className='text-[11px] font-medium uppercase tracking-[0.12em]' style={{ color: 'var(--accent)' }}>
              {isAdmin ? 'Admin' : 'Employee'}
            </span>
          </div>
          <h1 className='page-title'>Leave Management</h1>
          <p className='page-subtitle'>
            {isAdmin ? 'Manage and review leave applications' : 'Your leave history and requests'}
          </p>
        </div>
                ...
                <div className='flex sm:flex-col items-center sm:items-start gap-4 sm:gap-0'>
                  ...
                  <div className='flex-1 sm:flex-none'>
                    <div className='flex items-baseline gap-1.5'>
                      ...
                      <span className='text-[11px]' style={{ color: 'var(--text-subtle)' }}>taken</span>
                    </div>
                    <p className='text-[12px] sm:text-[13px] font-medium mt-1 sm:mt-2'
