...
// Create Payslip POST (/api/payslip)
export const createPayslip = async (req, res) => {
    try {
        ...
        return res.status(400).json({error: "Failed to create payslip."})
    }
}

// Get Payslip GET (/api/payslip)
export const getPayslip = async (req, res) => {
    try {
        ...
        return res.status(500).json({error: "Failed to get the Payslip"})
    }
}

// Get payslip by id GET(/api/payslip/:id)
