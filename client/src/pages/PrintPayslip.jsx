        ...
        <table className='w-full text-sm'>
          ...
          <tbody>
            <tr className='border-t border-slate-100'>
              ...
              <td className='text-right py-3 px-4 text-xs text-slate-500 uppercase tracking-wider'>₹{payslip.basicSalary?.toLocaleString()}</td>
            </tr>
            <tr className='border-t border-slate-100'>
              <td className='py-3 px-4 text-slate-700'>Allowances</td>
              <td className='text-right py-3 px-4 text-xs text-slate-500 uppercase tracking-wider'>{payslip.allowances?.toLocaleString()}</td>
            </tr>
            <tr className='border-t border-slate-100'>
              <td className='py-3 px-4 text-slate-700'>Deductions</td>
              <td className='text-right py-3 px-4 text-xs text-slate-500 uppercase tracking-wider'>{payslip.deductions?.toLocaleString()}</td>
            </tr>
            <tr className='border-t-2 border-slate-50'>
              <td className='py-3 px-4 text-slate-700'>Net Salary</td>
              <td className='text-right py-3 px-4 text-xs text-slate-500 uppercase tracking-wider'>{payslip.netSalary?.toLocaleString()}</td>
            </tr>
          </tbody>
        </table>
      </div>
